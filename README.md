...
This project demonstrates communication between an EC2 instance and an Amazon S3 bucket using a C program and the AWS CLI. The program creates a file containing system information, uploads it to an S3 bucket, lists the bucket contents, and downloads the file back to the EC2 instance.

Features
Create a text file with timestamp and system information
